import { Renderer, Program, Mesh, Triangle } from 'https://cdn.jsdelivr.net/npm/ogl@1.0.1/+esm';
...
export function initLineWaves(container, opts = {}) {
  ...
  // Ensure canvas fills container and doesn't block clicks
...
// Auto-init on hero waves container
const heroContainer = document.getElementById('heroWaves');
if (heroContainer) {
  initLineWaves(heroContainer, {
    speed: 0.25,
    innerLineCount: 24,
    outerLineCount: 28,
    warpIntensity: 0.8,
